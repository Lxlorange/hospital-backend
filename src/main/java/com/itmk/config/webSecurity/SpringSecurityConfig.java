    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(tokenFilter, UsernamePasswordAuthenticationFilter.class)
                ...
                .authorizeHttpRequests((authorized ) ->authorized
                                // 配置不需要认证即可访问的白名单接口
                                .requestMatchers("/api/sysUser/getImage", "/api/sysUser/login","/api/upload/uploadImage","/images/**","/wxapi/allApi/**","/wxapi/allapi/**","/swagger-ui/**","/swagger-ui.html","/swagger-resources/**","/v3/api-docs","/v2/api-docs","/webjars/**","/api/sysUser/api-docs","/webjars","/doc.html","/favicon.ico").permitAll()
                        // 其他所有请求都需要认证
